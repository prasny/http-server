...
/**
 * Lista kodów odpowiedzi używanych w {@link IResponse}
 *
...
public enum HttpStatus {
    ...
    /**
     * Znajdź wartość enumeryczną na podstawie podanego kodu HTTP
     * @param value kod HTTP
     * @return odnaleziona wartość enumeryczna
     */
    public static HttpStatus find(int value) {
        for (HttpStatus status : HttpStatus.values()) {
            if (status.getValue() == value) {
                return status;
            }
        }
        throw new IllegalArgumentException("pl.prasny.component.api.http.type.illegal_argument");
    }

    /**
     * Pobierz wartość kodu HTTP
     */
    public int getValue() {
        return this.value;
    }
    ...
    /**
     * Pobierz wiadomość powiązaną w kodem HTTP
     */
